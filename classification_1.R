...
df_cv <- vfold_cv(df_clr, strata = "Label1", v = k_fold) 
...
df_pca_cv <- vfold_cv(df_pca, strata = "Label1", v = k_fold)
...
file_path <- "Output/classification_1/ConfusionMatrix_train.txt"
sink(file_path)
...
file_path <- "Output/classification_1/ConfusionMatrix_test.txt"
sink(file_path)
"Confusion matrix: CART"
sink(file_path,  append = TRUE)
p_test_cart
...
file_path <- "Output/classification_1/prediction_class_train.txt"
sink(file_path)
"CART" 
sink(file_path,  append = TRUE)
performance_cart_train_class
...
file_path <- "Output/classification_1/prediction_class_test.txt"
sink(file_path)
"CART" 
sink(file_path,  append = TRUE)
performance_cart_test_class
...
## hyper parameter
file_path <- "Output/classification_1/hyperperameter.txt"
sink(file_path)
...
## variable importance
file_path <- "Output/classification_1/variable importance.txt"
sink(file_path)
"CART" 
sink(file_path,  append = TRUE)
