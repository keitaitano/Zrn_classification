...
for (l in 1: factor_down){
  ...
  print("RF")
  sink(file_path,  append = TRUE)
  print(performance_rf_train_class)
  sink(file_path,  append = TRUE)
  print("SVM")
  sink(file_path,  append = TRUE)
  print(performance_svm_train_class)
  closeAllConnections()
  ...
  print("RF")
  sink(file_path,  append = TRUE)
  print(performance_rf_test_class)
  sink(file_path,  append = TRUE)
  print("SVM")
  sink(file_path,  append = TRUE)
  print(performance_svm_test_class)
  closeAllConnections()
